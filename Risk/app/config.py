...
# Hedged / matched live-casino bets (e.g. banker + player same round to inflate transaction count).
HEDGE_BETTING_ENABLED = True
HEDGE_BETTING_WINDOW_SECONDS = 3600
HEDGE_BETTING_ROUND_LEG_TTL_SECONDS = 600
HEDGE_BETTING_TIME_PAIR_WINDOW_SECONDS = 15
HEDGE_BETTING_REQUIRE_ROUND_ID = False
HEDGE_BETTING_OPPOSITE_GROUPS = [["banker", "player"]]
HEDGE_BETTING_AMOUNT_TOLERANCE_PERCENT = 10.0
HEDGE_BETTING_OPPOSITE_SIDE_SCORE = 50
HEDGE_BETTING_ROUND_MEDIUM = 3
HEDGE_BETTING_ROUND_HIGH = 8
HEDGE_BETTING_ROUND_CRITICAL = 15
HEDGE_BETTING_ROUND_MEDIUM_SCORE = 30
HEDGE_BETTING_ROUND_HIGH_SCORE = 50
HEDGE_BETTING_ROUND_CRITICAL_SCORE = 70
HEDGE_BETTING_VOLUME_WASHING_ENABLED = True
HEDGE_BETTING_MIN_GROSS_VOLUME = 5000.0
HEDGE_BETTING_MIN_HEDGED_GROSS_RATIO = 0.5
HEDGE_BETTING_VOLUME_WASHING_SCORE = 55
