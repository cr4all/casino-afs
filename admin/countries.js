/** ISO 3166-1 alpha-2 country/territory codes for admin multiselects */
(function () {
  ...
  function getLocale() {
    return window.AdminI18n?.getLocale?.() || "en";
  }
  ...
  function countryLabel(code, locale) {
    ...
    try {
      ...
      /* Intl unavailable for this locale/code */
    }
    return upper;
  }

  function sortedOptions(locale, extraCodes) {
